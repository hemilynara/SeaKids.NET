...
namespace SeaKids.Controllers
{
    public class CadastrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,Senha,Nome")] Cadastro cadastro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,Senha,Nome")] Cadastro cadastro)
        {
            if (id != cadastro.Id)
            {
                return NotFound();
